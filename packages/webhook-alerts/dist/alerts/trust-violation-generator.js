...
exports.TrustViolationAlertGenerator = void 0;
/**
 * Generates webhook alerts for trust violations
 */
class TrustViolationAlertGenerator {
    /**
     * Generate alert for trust score below threshold
     */
    generateTrustScoreBelowThresholdAlert(trustScore, threshold, context) {
        return {
     ...
     */
    generateCriticalViolationAlert(trustScore, principle, description, context) {
        return {
     ...
     */
    generateErrorViolationAlert(trustScore, principle, description, context) {
        return {
     ...
     */
    generateWarningViolationAlert(trustScore, principle, description, context) {
        return {
     ...
     */
    generateMultipleViolationsAlert(trustScore, violations, context) {
     ...
     */
    getViolatingPrinciples(trustScore, threshold) {
     ...
     */
    getViolationSeverity(score, threshold) {
     ...
     */
    getEventTypeForSeverity(severity) {
        switch (severity) {
            case 'critical':
...
exports.TrustViolationAlertGenerator = TrustViolationAlertGenerator;
