 ...
 * Webhook event types
 */
export type WebhookEventType = 'trust_violation_critical' | 'trust_violation_error' | 'trust_violation_warning' | 'trust_score_below_threshold' | 'principle_violation' | 'emergence_detected' | 'agent_error' | 'agent_offline' | 'compliance_breach' | 'system_error' | 'performance_degradation' | 'security_incident' | 'audit_required';
/**
 ...
 * Filter operators
 */
export type FilterOperator = 'equals' | 'not_equals' | 'contains' | 'not_contains' | 'greater_than' | 'less_than' | 'greater_equal' | 'less_equal' | 'in' | 'not_in' | 'regex';
/**
 * Retry policy
 */
 ...
 */
export type SecurityIncidentType = 'unauthorized_access' | 'data_breach' | 'injection_attack' | 'dos_attack' | 'authentication_failure' | 'authorization_failure' | 'suspicious_activity' | 'malware_detected';
/**
 * Security severity
 */
 ...
 * Delivery status
 */
export type DeliveryStatus = 'pending' | 'in_progress' | 'delivered' | 'failed' | 'retrying' | 'expired' | 'cancelled';
/**
 * Webhook response
 */
 ...
 * Error types
 */
export type ErrorType = 'network_error' | 'timeout_error' | 'http_error' | 'validation_error' | 'rate_limit_error' | 'authentication_error' | 'parse_error' | 'unknown_error';
/**
