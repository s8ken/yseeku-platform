 ...
 */
export type AgentType = 'repository_manager' | 'website_manager' | 'code_reviewer' | 'tester' | 'deployer' | 'monitor' | 'researcher' | 'coordinator';
...
export type TaskType = 'code_review' | 'bug_fix' | 'feature_development' | 'documentation' | 'testing' | 'deployment' | 'monitoring' | 'research' | 'collaboration';
export type MessageType = 'task_request' | 'task_response' | 'collaboration_invite' | 'collaboration_response' | 'status_update' | 'error_report' | 'resource_lock' | 'resource_release' | 'heartbeat';
