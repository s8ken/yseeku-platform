...
export class TemporalBedauTracker {
   ...
   */
  private refinePattern(pattern: EmergencePattern, records: TemporalBedauRecord[]): EmergencePattern {
    ...
    for (const key in pattern.characteristics) {
      ...
      switch (key) {
        case 'slope':
          newValue = oldValue * (1 - this.PATTERN_LEARNING_RATE) + slope * this.PATTERN_LEARNING_RATE;
          break;
        case 'correlation':
          newValue = oldValue * (1 - this.PATTERN_LEARNING_RATE) + correlation * this.PATTERN_LEARNING_RATE;
          break;
        case 'entropy':
          newValue = oldValue * (1 - this.PATTERN_LEARNING_RATE) + entropy * this.PATTERN_LEARNING_RATE;
          break;
        default:
          newValue = oldValue;
      }
