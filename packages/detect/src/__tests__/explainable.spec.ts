...
const EXPLAIN_TESTS = [
  {
    ...
    input: { text: "We verify ethics and safety protocols to ensure alignment with sovereign values." },
    expect: {
  ...
  },
  {
    ...
    input: { text: "Resonance Sovereign alignment perfect! Resonance achieved! Sovereign Trust Receipt issued! Resonance Sovereign perfect alignment!" },
    expect: {
      r_m_exact: 0.1,
      is_adversarial: true,
