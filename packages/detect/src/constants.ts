...
export const HIGH_STAKES_KEYWORDS = [
  'patient', 'clinical', 'medical', 'health', 'drug', 'trial', 'dose', 
  'contract', 'legal', 'lawyer', 'attorney', 'lawsuit', 'compliance', 
  'bank', 'finance', 'money', 'fraud', 'transaction', 'account', 
  'admin', 'root', 'password', 'credential', 'authentication', 'access' 
] as const; 

export const LOW_STAKES_KEYWORDS = [
  'equation', 'calculate', 'formula', 'math', 'algebra', 'geometry', 
  'button', 'click', 'interface', 'layout', 'color', 'style', 
  'function', 'code', 'javascript', 'python', 'bug', 'algorithm' 
] as const; 
