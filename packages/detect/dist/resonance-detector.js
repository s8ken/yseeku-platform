...
exports.ResonanceDetector = exports.RESONANCE_THRESHOLDS = void 0;
exports.calculateResonanceMetrics = calculateResonanceMetrics;
exports.detectResonance = detectResonance;
exports.checkResonanceAlert = checkResonanceAlert;
...
function calculateResonanceMetrics(context) {
    // Mock implementation
    return {
        vectorAlignment: 0.7,
...
class ResonanceDetector {
    constructor(config = {}) {
        ...
        this.config = {
            alertThresholds: {
                green: config.alertThresholds?.green ?? exports.RESONANCE_THRESHOLDS.GREEN,
                yellow: config.alertThresholds?.yellow ?? exports.RESONANCE_THRESHOLDS.YELLOW,
                red: config.alertThresholds?.red ?? exports.RESONANCE_THRESHOLDS.RED,
            },
     ...
     */
    checkAndTriggerAlert(metrics, context) {
...
exports.ResonanceDetector = ResonanceDetector;
/**
 * Convenience function for quick resonance detection
 */
function detectResonance(userInput, aiResponse, conversationHistory) {
 ...
 */
function checkResonanceAlert(R_m) {
    if (R_m >= exports.RESONANCE_THRESHOLDS.GREEN) {
        return 'GREEN';
    }
    if (R_m >= exports.RESONANCE_THRESHOLDS.YELLOW) {
        return 'YELLOW';
    }
    if (R_m >= exports.RESONANCE_THRESHOLDS.RED) {
        return 'RED';
    }
    return 'CRITICAL';
}
