...
SONATE Detect provides production-grade real-time monitoring of AI interactions using a 5-dimension scoring model built on top of the 6 SONATE trust principles implemented in `@sonate/core`. Designed for < 100ms latency in production environments.
