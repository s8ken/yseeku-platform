...
[![npm version](https://img.shields.io/npm/v/@yseeku/trust-receipts.svg)](https://www.npmjs.com/package/@yseeku/trust-receipts)
...
- **[`@yseeku/verify-sdk`](https://www.npmjs.com/package/@yseeku/verify-sdk)** — For verifying SONATE platform receipts (server-side verification of receipts generated by the SONATE backend)
- **[`@yseeku/schemas`](https://www.npmjs.com/package/@yseeku/schemas)** — JSON Schema + TypeScript types for Trust Receipts
