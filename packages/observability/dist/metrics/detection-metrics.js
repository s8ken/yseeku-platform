...
exports.DetectionMetrics = void 0;
...
class DetectionMetrics {
    constructor() {
        this.meter = api_1.metrics.getMeter('sonate-detect');
        ...
        this.bedauIndexHistogram = this.meter.createHistogram('sonate_bedau_index', {
            description: 'Bedau Index values for emergence detection',
            unit: 'index',
        });
        this.emergenceDetectedCounter = this.meter.createCounter('sonate_emergence_detected_total', {
            description: 'Total number of emergence detections',
        });
        this.algorithmPerformanceHistogram = this.meter.createHistogram('sonate_detection_algorithm_performance_ms', {
     ...
     */
    recordBatchDetectionPerformance(batchData) {
...
exports.DetectionMetrics = DetectionMetrics;
