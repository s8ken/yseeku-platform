...
exports.OBSERVABILITY_ENV_VARS = exports.DEFAULT_OBSERVABILITY_CONFIG = void 0;
exports.validateConfig = validateConfig;
exports.loadConfigFromEnv = loadConfigFromEnv;
/**
 * Default configuration for SONATE observability
 */
exports.DEFAULT_OBSERVABILITY_CONFIG = {
...
function validateConfig(config) {
    const merged = { ...exports.DEFAULT_OBSERVABILITY_CONFIG, ...config };
