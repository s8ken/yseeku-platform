 ...
 */
export declare function explainableSymbiResonance(transcript: Transcript, options?: {
    max_evidence?: number;
}): Promise<ExplainedResonance>;
/**
 * Enhanced main function with all mathematical improvements
 */
export declare function robustSymbiResonance(transcript: Transcript): Promise<RobustResonanceResult>;
/**
