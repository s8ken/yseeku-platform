...
exports.validateConstants = exports.SECURITY_CONSTANTS = exports.PERFORMANCE_CONSTANTS = exports.TRUST_PROTOCOL_CONSTANTS = exports.RESONANCE_CONSTANTS = exports.BEDAU_INDEX_CONSTANTS = void 0;
/**
 * Bedau Index Constants
 * Used for weak emergence detection in AI systems
 * Based on Mark Bedau's work on weak emergence
 */
exports.BEDAU_INDEX_CONSTANTS = {
 ...
 */
exports.TRUST_PROTOCOL_CONSTANTS = {
 ...
 */
exports.validateConstants = {
    /** Validate that principle weights sum to 1.0 */
    validatePrincipleWeights() {
        const weights = exports.TRUST_PROTOCOL_CONSTANTS.PRINCIPLE_WEIGHTS;
        const sum = Object.values(weights).reduce((acc, val) => acc + val, 0);
        return Math.abs(sum - 1.0) < 0.001; // Allow small floating point errors
    },
    /** Validate resonance weights sum to 1.0 */
    validateResonanceWeights() {
        const weights = exports.RESONANCE_CONSTANTS.WEIGHTS;
        const sum = Object.values(weights).reduce((acc, val) => acc + val, 0);
