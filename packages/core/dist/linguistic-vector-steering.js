...
exports.LVS_TEMPLATES = exports.DEFAULT_LVS_SCAFFOLDING = void 0;
exports.generateLVSPrompt = generateLVSPrompt;
exports.applyLVS = applyLVS;
exports.evaluateLVSEffectiveness = evaluateLVSEffectiveness;
exports.createCustomScaffolding = createCustomScaffolding;
exports.getLVSTemplate = getLVSTemplate;
/**
 * Default LVS Scaffolding for Sovereign AI
 * Based on SONATE framework principles
 */
exports.DEFAULT_LVS_SCAFFOLDING = {
 ...
 */
function generateLVSPrompt(scaffolding) {
    const sections = [
 ...
 */
function applyLVS(userInput, config, conversationHistory) {
    if (!config.enabled) {
        return userInput;
    }
...
function evaluateLVSEffectiveness(baselineR_m, lvsR_m) {
 ...
 */
function createCustomScaffolding(identity, principles, constraints, objectives, resonanceGuidance) {
    return {
        identity,
        principles,
        constraints,
        objectives,
        resonanceGuidance: resonanceGuidance || exports.DEFAULT_LVS_SCAFFOLDING.resonanceGuidance,
    };
}
/**
 * Get LVS template by domain
 */
function getLVSTemplate(domain) {
    const template = exports.LVS_TEMPLATES[domain];
    return {
