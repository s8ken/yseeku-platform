...
exports.RESONANCE_THRESHOLDS = exports.DEFAULT_RESONANCE_WEIGHTS = void 0;
exports.calculateVectorAlignment = calculateVectorAlignment;
exports.calculateContextualContinuity = calculateContextualContinuity;
exports.calculateSemanticMirroring = calculateSemanticMirroring;
exports.calculateEntropyDelta = calculateEntropyDelta;
 ...
 */
exports.DEFAULT_RESONANCE_WEIGHTS = {
 ...
 */
function calculateVectorAlignment(userInput, aiResponse) {
 ...
 */
function calculateContextualContinuity(aiResponse, conversationHistory) {
 ...
 */
function calculateSemanticMirroring(userInput, aiResponse) {
 ...
 */
function calculateEntropyDelta(aiResponse) {
 ...
 */
function calculateResonanceMetrics(context, weights = exports.DEFAULT_RESONANCE_WEIGHTS) {
    // Calculate components
    const vectorAlignment = calculateVectorAlignment(context.userInput, context.aiResponse);
    const contextualContinuity = calculateContextualContinuity(context.aiResponse, context.conversationHistory);
    ...
    const weightedSum = vectorAlignment * weights.vectorAlignment +
 ...
 */
function calculateResonance(userInput, aiResponse, conversationHistory) {
