...
describe('Metrics Utility', () => {
  ...
  describe('HTTP Metrics', () => {
    it('should record HTTP request duration', () => {
      httpRequestDurationHistogram.observe({ method: 'GET', route: '/api/test', status_code: '200' }, 0.150);
      httpRequestDurationHistogram.observe({ method: 'POST', route: '/api/data', status_code: '201' }, 0.300);
  ...
  describe('Integration Tests', () => {
    it('should work with complete workflow scenario', async () => {
      ...
      // Simulate HTTP calls
      httpRequestDurationHistogram.observe({ method: 'GET', route: '/api/data', status_code: '200' }, 0.1);
