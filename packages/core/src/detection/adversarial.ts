// @sonate/core/detection/adversarial.ts
...
export async function adversarialCheck(
  ...
  // 6. LLM ADVERSARIAL CHECK (Removed for Core Migration)
  // Core does not depend on LLM client. New CalculatorV2 handles this layer.
  const llmPenalty = 0;
