...
if __name__ == "__main__": 
    ...
    print("--- SONATE RESONANCE CHECK ---") 
    
    print("\n[Testing Resonant Response]") 
    result_high = calc.calculate_resonance(user_input, ai_response_resonant, history, interaction_id="test_001") 
    print(result_high) 
    
    print("\n[Testing Bland Response]") 
    result_low = calc.calculate_resonance(user_input, ai_response_bland, history, interaction_id="test_002") 
    print(result_low)
