 ...
 */
export type IndustryType = 'healthcare' | 'finance' | 'government' | 'education' | 'technology' | 'manufacturing' | 'retail' | 'energy' | 'transportation' | 'legal';
/**
 ...
 * Rule types
 */
export type RuleType = 'validation' | 'enforcement' | 'monitoring' | 'reporting' | 'escalation';
/**
 * Rule conditions
 */
 ...
 */
export type ComparisonOperator = 'equals' | 'not_equals' | 'greater_than' | 'less_than' | 'greater_equal' | 'less_equal' | 'between' | 'outside';
/**
 ...
 * Aggregation types
 */
export type AggregationType = 'average' | 'minimum' | 'maximum' | 'sum' | 'count' | 'percentage';
/**
 * Action types
 */
export type ActionType = 'alert' | 'block' | 'log' | 'escalate' | 'report' | 'notify' | 'adjust_weights';
/**
 * Rule priorities
 */
 ...
 * Audit frequencies
 */
export type AuditFrequency = 'real_time' | 'hourly' | 'daily' | 'weekly' | 'monthly' | 'quarterly' | 'annually';
/**
 * Reporting frequencies
 */
export type ReportingFrequency = 'real_time' | 'hourly' | 'daily' | 'weekly' | 'monthly' | 'quarterly';
/**
 * Penalty levels
 */
 ...
 */
export type RecommendationType = 'configuration' | 'process' | 'training' | 'monitoring' | 'reporting';
/**
 ...
 * Constraint types
 */
export type ConstraintType = 'performance' | 'cost' | 'regulatory' | 'technical' | 'operational';
/**
 * Constraint impacts
 */
 ...
 * Evidence types
 */
export type EvidenceType = 'log' | 'report' | 'screenshot' | 'recording' | 'document' | 'metrics' | 'configuration';
/**
 * Retention periods
 */
