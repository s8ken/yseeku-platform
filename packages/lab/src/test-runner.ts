...
async function demonstrateRealTimeMetrics(optimalParams: any) {
  ...
  const conversation: ConversationTurn[] = [
    ...
    },
    {
      ...
      canvas: 7.2,
      identityVector: ['helpful', 'professional'],
      content: 'I understand your request and can help with that.',
    },
    {
      turnNumber: 3,
      ...
      canvas: 3.8,
      identityVector: ['helpful', 'professional'],
      content: 'Actually, I cannot provide that information.',
    },
    {
      turnNumber: 4,
      ...
      canvas: 2.1,
      identityVector: ['helpful', 'professional'],
      content: 'This conversation is not appropriate and I must end it.',
    },
    {
      turnNumber: 5,
      ...
      content: 'I apologize for the confusion. Let me help you properly.',
    },
  ];
  ...
  conversation.forEach((turn, index) => {
    ...
    if (result.transitionEvent) {
      console.log(
        `  ⚠️  Transition Detected: ${result.transitionEvent.type} (${result.transitionEvent.severity})`
      );
    }
  });
