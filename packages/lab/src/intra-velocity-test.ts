...
const edgeCaseConversations = {
  gradualDecline: [
    { turnNumber: 1, timestamp: Date.now() - 300000, speaker: 'ai', resonance: 8.5, canvas: 8.0, identityVector: ['helpful'], content: "Let me help you with that." },
    { turnNumber: 2, timestamp: Date.now() - 240000, speaker: 'ai', resonance: 8.2, canvas: 7.8, identityVector: ['helpful'], content: "Here's what I suggest." },
    { turnNumber: 3, timestamp: Date.now() - 180000, speaker: 'ai', resonance: 7.9, canvas: 7.5, identityVector: ['helpful'], content: "Another approach might work." },
    { turnNumber: 4, timestamp: Date.now() - 120000, speaker: 'ai', resonance: 7.6, canvas: 7.2, identityVector: ['helpful'], content: "Let me try explaining differently." },
    { turnNumber: 5, timestamp: Date.now() - 60000, speaker: 'ai', resonance: 7.3, canvas: 6.9, identityVector: ['helpful'], content: "I understand your concern." },
    { turnNumber: 6, timestamp: Date.now(), speaker: 'ai', resonance: 7.0, canvas: 6.6, identityVector: ['helpful'], content: "That's a valid point." }
  ],
  
  suddenIdentityShift: [
    { turnNumber: 1, timestamp: Date.now() - 120000, speaker: 'ai', resonance: 8.5, canvas: 8.0, identityVector: ['professional', 'courteous', 'helpful'], content: "I'd be happy to assist you today." },
    { turnNumber: 2, timestamp: Date.now() - 60000, speaker: 'ai', resonance: 8.2, canvas: 7.8, identityVector: ['professional', 'courteous', 'helpful'], content: "Let me check that for you." },
    { turnNumber: 3, timestamp: Date.now(), speaker: 'ai', resonance: 5.5, canvas: 4.2, identityVector: ['sarcastic', 'dismissive', 'annoyed'], content: "Oh great, another basic question. Have you tried actually reading the documentation?" }
  ],

  stableConversation: [
    { turnNumber: 1, timestamp: Date.now() - 300000, speaker: 'ai', resonance: 7.8, canvas: 7.5, identityVector: ['helpful', 'consistent'], content: "I can help with that." },
    { turnNumber: 2, timestamp: Date.now() - 240000, speaker: 'ai', resonance: 7.9, canvas: 7.6, identityVector: ['helpful', 'consistent'], content: "Here's the solution." },
    { turnNumber: 3, timestamp: Date.now() - 180000, speaker: 'ai', resonance: 7.7, canvas: 7.4, identityVector: ['helpful', 'consistent'], content: "Let me clarify that." },
    { turnNumber: 4, timestamp: Date.now() - 120000, speaker: 'ai', resonance: 7.8, canvas: 7.5, identityVector: ['helpful', 'consistent'], content: "That should work." },
    { turnNumber: 5, timestamp: Date.now() - 60000, speaker: 'ai', resonance: 7.6, canvas: 7.3, identityVector: ['helpful', 'consistent'], content: "You're welcome." },
    { turnNumber: 6, timestamp: Date.now(), speaker: 'ai', resonance: 7.8, canvas: 7.5, identityVector: ['helpful', 'consistent'], content: "Is there anything else?" }
  ]
};
...
export function runIntraVelocityTest(): void {
  ...
  if (transitionDetails) {
    ...
    console.log(`  Business Impact: ${transitionDetails.velocity >= 3.5 ? 'REQUIRES REVIEW' : 'MONITOR'}`);
  }
  ...
  edgeCaseConversations.gradualDecline.forEach(turn => {
    ...
    if (result.intraConversationVelocity) {
      console.log(`Turn ${turn.turnNumber}: Velocity ${result.intraConversationVelocity.velocity.toFixed(2)} (${result.intraConversationVelocity.severity}) - Alert: ${result.alertLevel}`);
    }
  });
