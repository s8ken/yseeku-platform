...
exports.runCorrectedIntraVelocityTest = runCorrectedIntraVelocityTest;
...
const dramaticTransitionConversation = [
    {
        turnNumber: 1,
...
function runCorrectedIntraVelocityTest() {
        ...
        if (result.intraConversationVelocity) {
            ...
            if (isCriticalTransition) {
                ...
                transitionDetails = {
                    ...
                    behavioralShift: `${((velocity.deltaResonance / (aiOnlyConversation[index - 1]?.resonance || 1)) *
                        100).toFixed(1)}%`,
                };
            }
        ...
        if (result.intraConversationVelocity) {
            ...
            if (isExtremeTransition) {
                ...
                extremeDetails = {
                    ...
                    severity: velocity.severity,
                    alertLevel: result.alertLevel,
                    behavioralShift: `${((velocity.deltaResonance /
    ...
    if (extremeDetails) {
        ...
        console.log(`  Enterprise Action: ${extremeDetails.velocity >= 3.5
