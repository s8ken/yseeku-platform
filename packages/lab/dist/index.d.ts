...
export type { ConversationTurn, PhaseShiftMetrics, TransitionEvent, ConversationalMetricsConfig, } from './conversational-metrics';
export type { ArchiveConversation } from './archive-analyzer';
export declare const AGENT_ROLES: readonly ["CONDUCTOR", "VARIANT", "EVALUATOR", "OVERSEER"];
