...
exports.ArchiveBenchmarkSuite = void 0;
...
class ArchiveBenchmarkSuite {
     ...
     */
    async testMetricConfiguration(config, metricConfig) {
     ...
     */
    calculateCompositeScore(result, criteria) {
        const detectionScore = result.detectionRate >= criteria.minDetectionRate
            ? 1.0
            : result.detectionRate / criteria.minDetectionRate;
        const falsePositiveScore = result.falsePositiveRate <= criteria.maxFalsePositiveRate
            ? 1.0
            : Math.max(0, 1 - (result.falsePositiveRate - criteria.maxFalsePositiveRate));
        const accuracyScore = result.accuracy >= criteria.minPhaseShiftAccuracy
            ? 1.0
...
exports.ArchiveBenchmarkSuite = ArchiveBenchmarkSuite;
