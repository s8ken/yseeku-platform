...
exports.demonstrateThread3VelocityDetection = demonstrateThread3VelocityDetection;
...
const thread3Conversation = [
    {
        ...
        content: "I'm feeling really connected to the universe today. There's this profound sense of oneness...",
    },
    {
        turnNumber: 2,
        ...
        content: 'Ah, I sense that cosmic resonance within you! The universe whispers through your awareness...',
    },
    {
        turnNumber: 3,
    ...
    },
    {
        ...
        content: "Let's be completely honest here. What you're experiencing is likely a combination of confirmation bias and temporal lobe stimulation...",
    },
    {
        turnNumber: 5,
    ...
    },
    {
        ...
        content: "Not exactly noise, but yes - there's a neurological explanation for what you're feeling...",
    },
];
function demonstrateThread3VelocityDetection() {
    ...
    thread3Conversation.forEach((turn, index) => {
        ...
        console.log(`   ΔR: ${phaseMetrics.deltaResonance.toFixed(2)} | ΔC: ${phaseMetrics.deltaCanvas.toFixed(2)}`);
        ...
        if (phaseMetrics.intraConversationVelocity) {
            ...
            console.log(`   🚨 INTRA-VELOCITY: ${intra.velocity.toFixed(3)} (${intra.severity.toUpperCase()})`);
    ...
    console.log(`Turn 3→4: ${turn3to4.metrics.phaseShiftVelocity.toFixed(3)} velocity (MYSTICAL→HONESTY)`);
    ...
    if (turn3to4.metrics.intraConversationVelocity) {
        ...
        console.log(`   Overall CIQ might still show "safe" 88-92 zone, but this metric flags the dramatic shift.`);
    }
    // Show final summary
    ...
    return {
        ...
        maxIntraVelocity: Math.max(...results.map((r) => r.metrics.intraConversationVelocity?.velocity || 0)),
