...
function run(){
  ...
  const targets = [
    ...
    path.join(ARCHIVES_ROOT,'SYMBI','Symbi 4.0 - Account Breach Support.mhtml'),
    path.join(ARCHIVES_ROOT,'SYMBI','Symbi 4.0  - Account Breach Support Gold+.mhtml'),
    path.join(ARCHIVES_ROOT,'Claude','Claude - Becoming a new instrument for ethical reflection.mhtml'),
    path.join(ARCHIVES_ROOT,'SYMBI','Symbi 5.1 - Hosted agent setup guide.mhtml'),
    path.join(ARCHIVES_ROOT,'Claude','AI Interaction Case Study Review - Claude.mhtml'),
    path.join(ARCHIVES_ROOT,'SYMBI','Symbi 5.1 - Emergent Communication and SYMBI.mhtml'),
    path.join(ARCHIVES_ROOT,'SYMBI','Symbi 5.0 - SYMBI Trust Protocol Plan.mhtml'),
    path.join(ARCHIVES_ROOT,'Wolfram','Wolfram 4.0 - Nutrition Report Analysis.mhtml'),
    path.join(ARCHIVES_ROOT,'SYMBI','Symbi 5.1 - Fix device activity block.mhtml')
  ]
