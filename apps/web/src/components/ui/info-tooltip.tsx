...
const glossary: Record<string, string> = {
  ...
  "FBI\u00b2": "Fleet Behavioral Interdependence & Irreducibility Index. Measures fleet-level emergent behavior across multi-agent systems using four information-theoretic sub-metrics.",
  ...
  "Strong Emergence": "Emergence with FBI\u00b2 > 0.7, indicating significant unpredictable collective behavior.",
  "Weak Emergence": "Emergence with FBI\u00b2 < 0.4, indicating predictable collective patterns.",
  "LINEAR": "FBI\u00b2 < 0.3: Predictable, reducible operations where system behavior can be fully explained by analyzing individual components. No emergent properties detected.",
  "WEAK_EMERGENCE": "FBI\u00b2 0.3-0.7: Novel patterns arising from complex interactions that cannot be predicted from individual agents alone, but can be explained after observation.",
  "HIGH_WEAK_EMERGENCE": "FBI\u00b2 > 0.7: Strong emergent phenomena where collective behavior significantly influences individual agents and creates fundamentally new system properties.",
