...
const glossary: Record<string, string> = {
  ...
  "Bedau Index v2": "Composite 0–1 emergence signal measuring fleet-level behavioral divergence via four sub-metrics: Φ Fleet Divergence, Ψ Temporal Irreducibility, Ω Cross-Agent Novelty, and Σ Drift Coherence.",
  ...
  "Fleet Divergence": "Φ component (×0.35): Semantic entropy measuring how agent outputs diverge across the fleet.",
  "Temporal Irreducibility": "Ψ component (×0.25): Kolmogorov complexity of interaction sequences over time.",
  "Cross-Agent Novelty": "Ω component (×0.25): Novel patterns not reducible to any single agent's behavior.",
  "Drift Coherence": "Σ component (×0.15): Coordinated behavioral drift across the agent fleet.",
  ...
  "Strong Emergence": "Bedau Index > 0.40, indicating high weak emergence with significant fleet behavioral divergence.",
  "Weak Emergence": "Bedau Index 0.15–0.40, indicating detectable but moderate fleet behavioral patterns.",
  "LINEAR": "Bedau ≤ 0.15: Predictable, reducible operations where system behavior can be fully explained by analyzing individual components. No emergent properties detected.",
  "WEAK_EMERGENCE": "Bedau 0.15–0.40: Novel patterns arising from complex interactions that cannot be predicted from individual agents alone, but can be explained after observation.",
  "HIGH_WEAK_EMERGENCE": "Bedau > 0.40: Significant fleet behavioral divergence where collective behavior influences individual agents and creates new system properties.",
