      ...
      async (data: {
        ...
        try {
          ...
          try {
            ...
            userMessage.trustScore =
              Math.round((userTrustEval.trustScore.overall / 10) * 5 * 10) / 10;
          } catch (trustError: unknown) {
            logger.error('Trust evaluation error (Socket.IO user message)', {
          ...
          if (generateResponse) {
            ...
            try {
              ...
              try {
                ...
                aiMessage.trustScore =
                  Math.round((aiTrustEval.trustScore.overall / 10) * 5 * 10) / 10;
