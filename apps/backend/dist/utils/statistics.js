...
exports.tStatistic = tStatistic;
exports.welchDegreesOfFreedom = welchDegreesOfFreedom;
exports.tTestPValue = tTestPValue;
exports.normalCDF = normalCDF;
exports.confidenceInterval = confidenceInterval;
exports.twoSampleTTest = twoSampleTTest;
exports.minimumSampleSize = minimumSampleSize;
 ...
 */
function cohensD(mean1, mean2, std1, std2, n1, n2) {
 ...
 */
function tStatistic(mean1, mean2, std1, std2, n1, n2) {
 ...
 */
function welchDegreesOfFreedom(std1, std2, n1, n2) {
 ...
 */
function confidenceInterval(mean1, mean2, std1, std2, n1, n2, confidenceLevel = 0.95) {
 ...
 */
function twoSampleTTest(sample1, sample2, alpha = 0.05) {
    const tStat = tStatistic(sample1.mean, sample2.mean, sample1.std, sample2.std, sample1.n, sample2.n);
    const df = welchDegreesOfFreedom(sample1.std, sample2.std, sample1.n, sample2.n);
    const pValue = tTestPValue(tStat, df);
    const effectSize = cohensD(sample1.mean, sample2.mean, sample1.std, sample2.std, sample1.n, sample2.n);
    const ci = confidenceInterval(sample1.mean, sample2.mean, sample1.std, sample2.std, sample1.n, sample2.n);
    return {
        tStat,
        pValue,
        effectSize,
 ...
 */
function minimumSampleSize(effectSize, power = 0.8, alpha = 0.05) {
 ...
 */
function calculatePower(effectSize, n1, n2, alpha = 0.05) {
    const zAlpha = 1.96;
