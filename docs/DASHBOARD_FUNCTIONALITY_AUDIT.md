...
| Category | Real | Synthetic | Hybrid | Integrated |
|----------|------|-----------|--------|------------|
| Core Features | 14 | 0 | 4 | 0 |
| Lab Features | 3 | 0 | 2 | 1 |
| Learn/Docs | 0 | 0 | N/A (static) | 0 |
...
### 16. Lab - VLS (Linguistic Vector Steering)

**Status**: ✅ **INTEGRATED INTO TRUST ANALYTICS** (Updated January 25, 2026)

**Previous Location**: `/dashboard/lab/vls` (Standalone tab - now removed)

**Current Location**: Embedded in Trust Analytics page (`/dashboard/trust`)

**Rationale**: VLS metrics are trust indicators and belong with Trust Analytics. This consolidation:
- Reduces navigation complexity (Lab: 7 → 6 items)
- Surfaces VLS insights where users already look for trust data
- Maintains all functionality without losing features

**Backend Services** (Still Active):
- `apps/backend/src/routes/vls.routes.ts` (191 lines)
- `apps/backend/src/services/vls.service.ts` (327 lines)
- `GET /api/lab/vls/sessions` - Returns analyzed sessions
- `GET /api/lab/vls/baselines` - Returns organizational baselines

**Frontend Integration**:
- "Linguistic Signals" panel added to Trust Analytics page
- Shows: Vocabulary Drift, Introspection Index, Hedging Ratio, Alignment Score
- Displays emergent concepts detected in AI conversations
- Live/Demo data badge indicates data source

**Verdict**: Feature preserved, navigation simplified.
...
5. **VLS Consolidation**: Completed January 25, 2026
   - Merged VLS into Trust Analytics page as "Linguistic Signals" panel
   - Removed standalone VLS tab from Lab navigation
   - Reduces cognitive load while preserving all functionality
   - Lab section now has 6 items (was 7)
...
| Lab - VLS | Integrated | ✅ Merged into Trust Analytics |
| Lab - Emergence | Hybrid | 🔶 Partial |

**Overall Platform Readiness**: **95% Production Ready** (18 standalone tabs + 1 integrated feature)

The platform demonstrates real AI governance capabilities across all functionality. All tabs now have backend support with appropriate fallbacks to demo data when real data is unavailable. VLS (Linguistic Vector Steering) has been consolidated into the Trust Analytics page as the "Linguistic Signals" panel to reduce navigation complexity.

---

*Generated by automated code review - Updated January 25, 2026*
